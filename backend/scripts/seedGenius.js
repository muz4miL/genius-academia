/**
 * ================================================================
 * GENIUS ACADEMY — Master Seed Script (Single-Owner Edition)
 * ================================================================
 ...
 * ================================================================
 * Usage:  node backend/scripts/seedGenius.js
 * ================================================================
 */
...
// ── Config ──────────────────────────────────────────────────────
const MONGO_URI = process.env.MONGO_URI || "mongodb://localhost:27017/genius-academia";
...
async function seed() {
  try {
    ...
    const session = await Session.create({
      ...
      description: "Main academic session for Genius Academy",
    ...
    const studentData = [
      // 3 in 10th Medical
      {
        ...
        email: "ali.hassan@student.genius.pk", address: "Islamabad",
      ...
      },
      {
        ...
        email: "fatima.noor@student.genius.pk", address: "Rawalpindi",
        classRef: class10th._id, assignedTeacher: physicsTeacher._id, assignedTeacherName: physicsTeacher.name,
      ...
      },
      {
        ...
        email: "usman.tariq@student.genius.pk", address: "Peshawar",
      ...
      // 2 in 12th Engineering
      {
        ...
        email: "sara.ahmed@student.genius.pk", address: "Lahore",
      ...
      },
      {
        ...
        email: "hamza.sheikh@student.genius.pk", address: "Karachi",
        classRef: class12th._id, assignedTeacher: mathTeacher._id, assignedTeacherName: mathTeacher.name,
    ...
    // ════════════════════════════════════════════════════════════
    console.log("\n" + "═".repeat(60));
    log("🎉", "GENIUS ACADEMY SEED COMPLETE!");
