...
interface ReceiptPDFProps {
  ...
  studentPhotoDataUrl?: string; // Student profile photo as data URL
}
...
export const ReceiptPDF = ({
  ...
  studentPhotoDataUrl, // Student profile photo data URL
}: ReceiptPDFProps) => {
      ...
      <Page size={[612, 396]} style={styles.page}>
        <View style={styles.container}>
          ...
          <View style={styles.mainContent}>
            ...
            {/* Center Section - Student Photo / ID */}
            <View style={styles.centerSection}>
              {studentPhotoDataUrl ? (
                <>
                  <Text style={styles.barcodeLabel}>STUDENT PROFILE</Text>
                  <Image
                  ...
                  />
                  <Text style={[styles.barcodeHint, { marginTop: 6 }]}>{student.studentId}</Text>
                </>
              ) : (
                <>
